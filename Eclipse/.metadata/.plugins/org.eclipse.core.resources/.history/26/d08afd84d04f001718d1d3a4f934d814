...
<title>Faça parte do Tindog</title>
</head>
<body>
	<div class="container">
		<div class="row">
			...
			<form class="form-horizontal"
				...
				<legend id='centro'>Cadastro de usuário</legend>
							...
							<div class="btn-group btn-group">
								<div class="container clearfix">
									<div class="col-md-6 configdiv">
										<button type="submit" class="btn btn-primary" id="cadastrar">Cadastre-se</button>

									</div>
									<div class="btn-group btn-group">
										<button id="voltar" type="submit" class="btn btn-danger"
											role="button" onClick="window.location.href='./login.jsp'">Voltar</button>
