        ...
        <tbody>
            <c:forEach items="${listaDeUsuarios}" var="usuario">
                <tr>
                    ...
                    <td><a
                        href="UsuarioController.do?action=editar&usuarioId=<c:out value="${usuario.id}"/>">editar</a></td>
                    <td><a
                        href="UsuarioController.do?action=remover&usuarioId=<c:out value="${usuario.id}"/>">remover</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
